...
public class FindMilitaryPlaneTest {
    ...
    @Test
    public void testFindMilitaryPlane() {
        String expected = "B-1B Lancer";
        String actual = planeByTypeFinder.findMilitaryPlanes(planeList).get(0).getPlaneModel();
        Assert.assertEquals(actual, expected);
    }

    @Test
    public void testFindMilitaryPlaneNegative() {
